...
version: '4.0'
title: 'ინსტალაცია'
keywords: 'ინსტალაცია, Phalcon-ის ინსტალაცია'
---
...
Phalcon v4 თავსებადია მხოლოდ PHP 7.2 და უფრო ახალ ვერსიებთან. PHP 7.1 გამოვიდა 2 წლის წინ და მისი [აქტიური მხარდაჭერა](https://www.php.net/supported-versions.php) დასრულდა, ამიტომ გადავწყვიტეთ თვალყური ვადევნოთ აქტიურად მხარდაჭერილ PHP ვერსიებს. ვებ სერვერის დაყენება ამ დოკუმენტის ფარგლებს სცილდება. გთხოვთ, გაეცნოთ მოიძიოთ შესაბამისი სახელმძღვანელოები ინტერნეტში, თუ როგორ დააყენოთ ვებ სერვერი.

### PSR

Phalcon-ს სჭირდება PSR გაფართოება. გაფართოების ჩამოტვირთვა და კომპილირება შესაძლებელია GitHub-ის [ამ] (https://github.com/jbboehr/php-psr) საცავიდან. ინსტალაციის ინსტრუქციები ხელმისაწვდომია `README` საცავში. თქვენ მიერ არჩეული ინსტალაციის მეთოდიდან გამომდინარე, შეიძლება დაგჭირდეთ დირექტივის დამატება თქვენს `php.ini-ში` რათა ჩაიტვირთოს PSR გაფართოება.

```ini
extension=psr.so
```

> **ᲨᲔᲜᲘᲨᲕᲜᲐ**: დაგჭირდებათ PSR 1.0 გაფართოების დაყენება..
{: .alert .alert-danger }
